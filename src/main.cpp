...
unsigned int nStakeMaxAge = 60 * 60 * 24 * 7; // 7 days as full weight
...
bool CTransaction::CheckTransaction() const
{
    ...
    for (unsigned int i = 0; i < vout.size(); i++)
    {
        ...
        // EiniaOraCoin: enforce minimum output amount for user transactions until 1 May 2014 04:00:00 GMT
...
{
	// fixed 365% mint rate
	int64 nRewardCoinYear = 365 * CENT;
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fStrictPayToScriptHash = true; // Always active in EiniaOraCoin
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    else
    {
        ...
        if(!fTestNet && fCheckSig)
        {
            ...
            // EiniaOraCoin: check proof-of-work block signature
...
// EiniaOraCoin: attempt to generate suitable proof-of-stake
